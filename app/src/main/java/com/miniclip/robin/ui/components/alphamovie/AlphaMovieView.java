package com.miniclip.robin.ui.components.alphamovie;
...
public class AlphaMovieView extends GLTextureView {
    ...
    public void setAlphaColor(@ColorInt int alphaColor) {
        renderer.setAlphaColor(alphaColor);
    }

    public void setCustomShader(String shaderProgram) {
        renderer.setCustomShader(shaderProgram);
    }
